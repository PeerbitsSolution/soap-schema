...
<!-- Short description. Link the issue it addresses if one exists. -->
...
<!-- Anything that needs extra attention — e.g. touches auth/token/PKCE
     logic and needs the mandatory security review. -->
